...
// Changes made by RWS in 2021:

// 2021-12-08:  RWS added D271comp namespaceadd blink LED while calibrate

// 2021-12-XX:  RWS, also note data type change around "#ifdef KINETISK" code
  ...
  // *****************************************************************************************
    ...
    */
    ...
    while(millis()-t <= 30000){
      ...
      if (blink1 != 0) {
        int v = (millis() / 250) %2;
        digitalWrite(blink1, v);
        if (blink2 != 0) {
          digitalWrite(blink2, !v);
        }
      }
    }
...
void compass_init(int gain, int _b1, int _b2){
